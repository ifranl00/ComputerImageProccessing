...
%% Exercise 5.
    % Display histograms of the images 3.jpg and 4.jpg, analyze them and adjust given images basing on information achieved from histograms. Use the imadjust function.
          R=imread('image3.jpeg');
          figure;
          imshow(R);
          title('Original image3.jpeg');
          
          S=imread('image4.jpeg');
          figure;
          imshow(S);
          title('Original image4.jpeg');
          
          % display histograms
          figure;
          imhist(R); %  calculates the histogram for the grayscale image I
          title('image3.jpeg histogram');
          
          figure;
          imhist(S); %  calculates the histogram for the grayscale image I
          title('image4.jpeg histogram');
          
          % adjust images
          
          R2= imadjust(R,[0.15 0.9],[0 1]); %lets try to increase the contrast
          figure;
          imshow(R2);
          title('Increased constrast of image3.jpeg');
          
          figure;
          imhist(R2); %  calculates the histogram for the grayscale image I
          title('image3.jpeg histogram after adjust contrast');
          
          S2= imadjust(S,[],[],0.5); %decreasing the contrast enough will wash out the image so lets try gamma correction
          figure;
          imshow(S2);
          title('Gamma correction of image4.jpeg');
          
          figure;
          imhist(S2); %  calculates the histogram for the grayscale image I
          title('image4.jpeg histogram after apply gamma correction');
